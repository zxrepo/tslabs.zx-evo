...
auto TsconfView::init() const -> void
{
	auto &col_0 = canvas_->create_column(23);
	auto &col_1 = canvas_->create_column(23);
	auto &col_2 = canvas_->create_column(23);
...
auto TsconfView::render() const -> void
{
	canvas_->paint();
}
